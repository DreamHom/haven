...
public class CommentController {
    ...
    public Page<CommentResponse> list(
        ...
        return commentService.list(listingId, pageable).map(CommentResponse::from);
    }
    ...
    public CommentResponse post(
        ...
        return CommentResponse.from(commentService.post(principal.userId(), listingId, request.body()));
    }
