...
@Slf4j
public class LocalAgentMarketingPhotoStorage implements AgentMarketingPhotoStorage {
    ...
    public String upload(MultipartFile file, Long userId) {
        ...
        String key = "agents/" + userId + "/gallery/" + UUID.randomUUID() + extension;
        String url = "https://media.dreamhomes.com/" + key;
        log.info("LocalAgentMarketingPhotoStorage: synthesised URL for userId={}: {}", userId, url);
        return url;
    }
