...
@Slf4j
public class R2AvatarPhotoStorage implements AvatarPhotoStorage {

    private final S3Client s3;
    private final String bucket;
    private final String publicBaseUrl;

    public R2AvatarPhotoStorage(
            S3Client s3,
    ...
    public String upload(MultipartFile file, Long userId) {
        ...
        String key = "avatars/" + userId + "/" + UUID.randomUUID() + extensionOf(file);
        ...
        log.info("R2AvatarPhotoStorage: uploaded avatar for userId={} to {}", userId, url);
        return url;
    }
