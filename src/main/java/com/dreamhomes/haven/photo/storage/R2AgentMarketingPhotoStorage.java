...
@Slf4j
public class R2AgentMarketingPhotoStorage implements AgentMarketingPhotoStorage {

    private final S3Client s3;
    private final String bucket;
    private final String publicBaseUrl;

    public R2AgentMarketingPhotoStorage(
            S3Client s3,
    ...
    public String upload(MultipartFile file, Long userId) {
        ...
        String key = "agents/" + userId + "/gallery/" + UUID.randomUUID() + extensionOf(file);
        ...
        log.info("R2AgentMarketingPhotoStorage: uploaded for userId={} to {}", userId, url);
        return url;
    }
